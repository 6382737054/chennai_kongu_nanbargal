 ...
 const locations = [
   {
     ...
     image: "/Images/contact/admin.jpg", 
     qrCode: "/Images/qr/admin-qr.png"
   },
   {
     ...
     emails: ["chennaikongu@gmail.com", "konguchennai@yahoo.com"],
     image: "/Images/contact/hostel.jpg",
     qrCode: "/Images/qr/hostel-qr.png"
   },
   {
           ...
           {locations.map((location, index) => (
             <div key={index} className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-500 group">
               <div className="relative h-48 overflow-hidden">
                 <img src={location.image} alt={location.title} className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-700"/>
                 <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
                 <h3 className="absolute bottom-4 left-4 right-4 text-white text-xl font-medium">{location.title}</h3>
               </div>
               ...
               <div className="p-6 space-y-4">
                 ...
                 <div className="space-y-2">
                   {location.phones.map((phone, idx) => (
                     <a key={idx} href={`tel:${phone.replace(/[^0-9]/g, '')}`} className="flex items-center space-x-3 text-gray-600 hover:text-green-700 transition-colors">
                 ...
                 <div className="space-y-2">
                   {location.emails.map((email, idx) => (
                     <a key={idx} href={`mailto:${email}`} className="flex items-center space-x-3 text-gray-600 hover:text-green-700 transition-colors">
                 ...
                 <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                   ...
                   <img src={location.qrCode} alt="Location QR" className="w-24 h-24 object-contain"/>
                 </div>
               </div>
             </div>
           ))}
